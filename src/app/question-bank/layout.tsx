...
export const metadata: Metadata = {
    ...
    description: '전국 중·고 내신·전국연합 모의고사 수학 기출 문제은행. 원하는 문제를 골라 유사문제까지 자동으로 채우고, 나만의 수학 시험지를 직접 만들어 한글 호환 HML 파일로 무료 다운로드하세요.',
    keywords: [
    ...
    openGraph: {
        title: '수학 문제은행 - 기출로 나만의 시험지 무료 제작 | 수학ETF',
        description: '전국 내신·모의고사 수학 기출 문제은행. 원하는 문제를 골라 유사문제까지 자동으로 채우고 나만의 수학 시험지를 직접 무료로 만드세요.',
        ...
        <>
            ...
            <section className="sr-only">
                ...
                <p>
                    ...
                    원하는 문제를 골라 직접 나만의 수학 시험지를 만들 수 있습니다.
                    과목·단원·난이도·키워드로 문제를 좁히고, 같은 유형의 유사문제를 자동으로 채워 시험지를 완성한 뒤
                    한글 호환 HML 파일로 다운로드하세요. PDF가 필요하면 한글에서 PDF로 저장할 수 있습니다. 로그인하면 완성한 시험지를 내 보관함에 저장할 수 있습니다.
                </p>
            </section>
            {children}
        </>
