            ...
            <div className="max-w-[1200px] mx-auto px-6 py-10 md:py-14">
                <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
                    ...
                    <div className="flex-1 text-center md:text-left">
                        {/* Badge */}
                        <div className="inline-flex items-center gap-1.5 bg-[#5CC6C3]/10 border border-[#5CC6C3]/30 text-[#3AADA9] text-xs font-bold px-3 py-1.5 rounded-full mb-5">
                            <Sparkles size={11} />
                            개인DB 전체 무료 공개 중!
                        </div>

                        {/* Headline */}
                        <h1 className="text-3xl md:text-4xl lg:text-[2.75rem] font-extrabold text-[#1E2D4F] leading-tight mb-3 break-keep">
                            전국 내신 기출문제를<br />
                            <span className="text-[#497AB7]">한 곳에서</span>
                        </h1>

                        {/* Subtitle */}
                        <p className="text-slate-500 text-sm md:text-base mb-7 break-keep leading-relaxed max-w-md mx-auto md:mx-0">
                        ...
                        <div className="flex flex-wrap gap-3 justify-center md:justify-start">
                            <Link
                                href="/question-bank"
                                className="inline-flex items-center gap-2 px-6 py-2.5 bg-[#497AB7] text-white font-bold rounded-full text-sm hover:bg-[#3A6599] transition-colors shadow-sm"
                            >
                                시험지 만들기 <ArrowRight size={15} />
                            </Link>
                            <a
                                href="#main-list"
                                className="inline-flex items-center gap-2 px-6 py-2.5 border-2 border-[#497AB7] text-[#497AB7] font-bold rounded-full text-sm hover:bg-[#497AB7]/5 transition-colors"
                            >
                                기출자료 보기
                            </a>
                        </div>
                    ...
                    {/* Right: stat cards */}
                    <div className="flex-shrink-0 flex flex-row md:flex-col gap-3 w-full md:w-60">
                        <div className="flex-1 md:flex-none bg-[#F2F3F0] rounded-2xl p-4 border border-[#B7D1EA]/40">
                        ...
                        <div className="flex-1 md:flex-none bg-[#F2F3F0] rounded-2xl p-4 border border-[#5CC6C3]/30">
                            <div className="flex items-center gap-3">
                        ...
                        {user && (
                            <div className="hidden md:block bg-gradient-to-br from-[#497AB7] to-[#5CC6C3] rounded-2xl p-4 text-white">
